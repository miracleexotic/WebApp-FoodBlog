            ...
            <Box sx={{ flexGrow: 1, display: 'flex', justifyContent: 'flex-end' }}>
              ...
              >
                <Button
                  ...
                  onClick={handleEdit}
                  sx={{background: 'linear-gradient(135deg, #6c6bf5 30%, #00cde5 90%)'}}
                >
                  Edit
                </Button>
                <Button
                  ...
                  sx={{background: 'linear-gradient(135deg, #fd145d 30%, #fc966d 90%)'}}
                >
                  Delete
                </Button>
              </ButtonGroup>
...
function PostComponent() {
  ...
  function getPostsWithLikeCount() {
    const apiUrl = `${process.env.REACT_APP_BACKEND_API}/posts/like/count/active`;
    const requestOptions = {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
